...
import { createNotes, obtainNotes, removeNotes, } from "../controllers/safeNotesController.js";
...
notesRouter.post("/notes", validateToken, validateSchemaMiddleware(noteSchema), createNotes);
