...
import { createCards, obtainCards, removeCards, } from "../controllers/cardsController.js";
...
cardsRouter.post("/cards", validateToken, validateSchemaMiddleware(cardSchema), createCards);
